...
.a1:							; Display the current character of the current drive
	...
	je .a5
	cmp [currdrive], byte 0eh			; CD/DVD Rom E
	je .a6
...
load:
	...
	mov ah, [currdrive]			;Load the file from the booted drive
	mov [temp], ah
	mov ah, [bootdev]
	mov [currdrive], ah
...
.a2:
	...
	jmp failure				;We failed to load the file
...
.a1:
	...
	cmp al, 'B'				; Floppy B
	je .a3
	cmp al, 'C'				; Hard Drive C
	je .a4
	cmp al, 'D'				; Hard Drive D
	je .a5
	cmp al, 'E'				; CD/DVD Rom E
	je .a6
	jmp .b1
	
.a2:
	mov [currdrive], byte 00h
	jmp .b2
	
.a3:
	mov [currdrive], byte 01h
	jmp .b2
	
.a4:
	mov [currdrive], byte 80h
	jmp .b2
	
.a5:
	mov [currdrive], byte 81h
	jmp .b2
	
.a6:
	mov [currdrive], byte 0eh
	jmp .b2
...
currdrive	db	00h
copyright	db	'STARTUP Operating System (OS) Version 1.3', 0x0a, '(C) Copyright DataFiles Inc. 1989-1990. All rights reserved.', 0x0a, 0x0a,0x0a, 0x00
driveerror	db	0x0a, 'ERROR ACCESSING DRIVE', 0x0a, 0x00
temp 		db	00h
